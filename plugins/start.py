...
async def help_handler(client: Client, message: Message):
    ...
    help_text = (
        ...
        f"|:---:|\n"
        f"| Daftar perintah utama pemutar audio, video & film |\n\n"
        f"| Perintah Utama | Keterangan Fungsi |\n"
        f"|:---|:---|\n"
        f"| `/play (judul/link)` | Putar audio di obrolan suara |\n"
        f"| `/vplay (judul/link)` | Putar video HD di obrolan suara |\n"
        f"| `/film` / `/movie` | Menonton Film bioskop di VC |\n"
        f"| `/pause` / `/resume` | Jeda atau lanjutkan lagu |\n"
        f"| `/skip` / `/stop` | Lewati lagu / reset antrean |\n"
        f"| `/seek (detik)` | Maju atau mundur posisi putar |\n"
        f"| `/queue` / `/loop` | Cek antrean / putar berulang |\n"
        f"| `/settings` | Pengaturan preferensi grup |\n\n"
        f"| Statistik Sistem | Detail Jumlah |\n"
        f"|:---|:---|\n"
        f"| Served Chats | `{chats_cnt:,} grup` |\n"
        f"| Served Users | `{users_cnt:,} pengguna` |\n\n"
        f"| 💡 Klik tombol kategori di bawah untuk panduan spesifik: |\n"
        f"|:---:|\n"
        f"| |"
    )
...
async def help_callback_handler(client: Client, query: CallbackQuery):
    ...
    help_texts = {
        "music": (
            ...
            f"|:---:|\n"
            f"| Kontrol pemutaran musik & antrean di Voice Chat |\n\n"
            f"| Pemutaran & Media | Keterangan Fungsi |\n"
            f"|:---|:---|\n"
            f"| `/play (judul/link)` | Putar audio YouTube di VC |\n"
            f"| `/play` (balas audio) | Putar file audio Telegram |\n"
            f"| `/playforce (judul)` | Putar lagu lewati antrean |\n"
            f"| `/seek (detik)` / `/ff` | Lompat maju / mundur audio |\n"
            f"| `/song (judul)` | Unduh file MP3 320kbps |\n"
            f"| `/lyrics (judul)` | Cari & tampilkan lirik |\n\n"
            f"| Playlist & Radio | Keterangan Fungsi |\n"
            f"|:---|:---|\n"
            f"| `/playlist` / `/save` | Buka / simpan playlist |\n"
            ...
            f"| Kontrol & Volume | Keterangan Fungsi |\n"
            f"|:---|:---|\n"
            f"| `/np` / `/queue` | Cek lagu aktif / antrean |\n"
            f"| `/shuffle` / `/loop` | Acak antrean / putar ulang |\n"
            f"| `/pause` / `/resume` | Jeda / lanjutkan pemutaran |\n"
            f"| `/skip` / `/stop` | Lewati lagu / reset antrean |\n"
        ...
        "effects": (
            ...
            f"| Perintah Efek | Keterangan Fungsi |\n"
            f"|:---|:---|\n"
        ...
        "admin": (
            ...
            f"| Perintah Admin | Keterangan Fungsi |\n"
            f"|:---|:---|\n"
        ...
        "sudo": (
            ...
            f"| Manajemen Server | Keterangan Fungsi |\n"
            f"|:---|:---|\n"
            ...
            f"| Database & Owner | Keterangan Fungsi |\n"
            f"|:---|:---|\n"
        ...
        "info": (
            ...
            f"| Perintah Info | Keterangan Fungsi |\n"
            f"|:---|:---|\n"
            f"| `/start` | Tampilkan pesan sambutan |\n"
