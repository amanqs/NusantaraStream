...
async def help_handler(client: Client, message: Message):
    ...
    help_text = (
        f"| 🤖 Panduan Penggunaan & Daftar Perintah {Config.BOT_NAME} |\n"
        f"|:---:|\n"
        f"| Berikut adalah daftar perintah utama yang dapat Anda gunakan: |\n\n"
        ...
        f"| `/film` / `/movie` | Menonton Film dari bioskop privat di VC |\n"
        f"| `/pause` | Menjeda pemutaran media saat ini |\n"
        f"| `/resume` | Melanjutkan pemutaran yang dijeda |\n"
...
async def help_callback_handler(client: Client, query: CallbackQuery):
    ...
    help_texts = {
        "music": (
            ...
            "|:---:|\n"
            "| Kontrol pemutaran lagu, antrean & lirik di Voice Chat |\n\n"
            "| Pemutaran & Media | Keterangan Fungsi |\n"
            "|:---|:---|\n"
            "| `/play <judul/link>` | Putar audio YouTube di VC |\n"
            "| `/play` (balas audio) | Putar berkas audio Telegram |\n"
            "| `/playforce <judul>` | Putar lagu & lewati antrean |\n"
            "| `/seek <detik>` / `/ff` | Lompat maju/mundur pemutaran |\n"
            "| `/song <judul>` | Unduh file MP3 320kbps + Art |\n"
            "| `/lyrics <judul>` | Cari & tampilkan lirik lagu |\n"
            "| `/radio` | Putar siaran Radio 24/7 Nasional |\n"
            "| `/autoplay <on/off>` | Putar rekomendasi otomatis |\n\n"
            "| Kontrol & Playlist | Keterangan Fungsi |\n"
            "|:---|:---|\n"
            "| `/playlist` / `/myplaylist` | Buka daftar playlist pribadi |\n"
            "| `/save <judul/link>` | Simpan lagu ke playlist |\n"
            "| `/playplaylist` | Putar semua lagu di playlist |\n"
            "| `/delplaylist <nomor>` | Hapus lagu dari playlist |\n"
            "| `/np` / `/nowplaying` | Tampilkan lagu yang diputar |\n"
            "| `/queue` / `/q` | Tampilkan antrean lagu saat ini |\n"
            "| `/shuffle` | Acak urutan lagu di antrean |\n"
            "| `/loop <1-10>` | Ulang pemutaran lagu x kali |\n"
            "| `/volume <1-200>` | Atur volume pemutaran (100%) |\n"
            "| `/mute` / `/unmute` | Bisukan atau buka suara asisten |\n"
            "| `/pause` / `/resume` | Jeda atau lanjutkan pemutaran |\n"
            "| `/skip` / `/next` | Lewati lagu ke berikutnya |\n"
            "| `/stop` / `/end` | Hentikan pemutaran & reset |\n\n"
            "| 🤖 Nusantara Stream 🤖 |\n"
            "|:---:|\n"
            "| |"
        ),
        "video": (
            ...
            "|:---:|\n"
            "| Streaming video 720p HD, bioskop & siaran TV di VC |\n\n"
            "| Video & Bioskop | Keterangan Fungsi |\n"
            "|:---|:---|\n"
            "| `/film` / `/movie` | Buka katalog & streaming film di VC |\n"
            "| `/film <judul>` | Cari & pilih film dari channel |\n"
            "| `/seek <detik>` / `/ff` | Lompat maju/mundur video/film |\n"
            "| `/vplay <judul/link>` | Putar video YouTube 720p di VC |\n"
            "| `/vplay` (balas video) | Putar berkas file video Telegram |\n"
            "| `/vplayforce <judul>` | Putar video & lewati antrean |\n\n"
            "| Live TV & Unduhan | Keterangan Fungsi |\n"
            "|:---|:---|\n"
            "| `/tv` / `/iptv` | Menu Live TV & remote ganti channel |\n"
            "| `/tv <link m3u8>` | Putar siaran IPTV/HLS kustom di VC |\n"
        ...
        "effects": (
            f"| ⚡ Panduan Efek Audio & Tempo — {Config.BOT_NAME} |\n"
            "|:---:|\n"
            "| Modifikasi audio dan kecepatan secara realtime di VC |\n\n"
            "| Perintah Efek | Keterangan Fungsi |\n"
            "|:---|:---|\n"
        ...
        "admin": (
            ...
            "| Perintah Admin | Keterangan Fungsi |\n"
            "|:---|:---|\n"
            "| `/settings` | Panel konfigurasi preferensi grup |\n"
        ...
        "sudo": (
            ...
            "|:---:|\n"
            "| Akses kontrol level pengembang & pemilik sistem bot |\n\n"
            "| Manajemen Server | Keterangan Fungsi |\n"
            "|:---|:---|\n"
            "| `/broadcast` | Kirim broadcast ke semua user & grup |\n"
            "| `/activevc` | Cek seluruh Voice Chat aktif berjalan |\n"
            "| `/clean` | Bersihkan berkas cache di server |\n"
            ...
            "| Database & Owner | Keterangan Fungsi |\n"
            "|:---|:---|\n"
            "| `/backup` | (Owner) Unduh cadangan SQLite .db |\n"
        ...
        "info": (
            ...
            "| Perintah Info | Keterangan Fungsi |\n"
            "|:---|:---|\n"
