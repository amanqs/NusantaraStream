...
async def help_callback_handler(client: Client, query: CallbackQuery):
    ...
    help_texts = {
        "music": (
            ...
            "| `/seek <detik>` / `/ff` / `/rw` | Lompat maju/mundur pemutaran audio |\n"
        ...
        "video": (
            "| 🎬 Panduan Perintah Video, Film & Live TV |\n"
            "|:---:|\n"
            "| Pemutaran video 720p HD, bioskop & siaran TV langsung |\n\n"
            "| Perintah | Deskripsi & Format Penggunaan |\n"
            "|:---|:---|\n"
            "| `/film` / `/movie` / `/bioskop` | Buka katalog & streaming film di VC |\n"
            "| `/film <judul>` | Cari & pilih film dari channel privat |\n"
            "| `/seek <detik>` / `/ff` / `/rw` | Lompat maju/mundur pemutaran video/film |\n"
            ...
            "| `/tv` / `/iptv` | Buka menu Siaran Live TV & remote ganti channel |\n"
